...
class Arbol:
    ...
    def show_nodos(self):
            nodos_children = []
            # Incluimos la raíz en el chequeo
            if self.raiz and self.raiz.izquierda and self.raiz.derecha:
                nodos_children.append(self.raiz.valor)

            # Luego evaluamos el resto de los nodos
